...
/* harmony import */ var _util_visible__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(428);
/* harmony import */ var _util_store__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(814);
/* harmony import */ var _util_constants_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(180);
...
var escapeKey = function escapeKey(e, $ulParents, focusCss) {
  if (e.key == _util_constants_js__WEBPACK_IMPORTED_MODULE_2__.KEYS.ESC) {
    if ($ulParents.length > 1) {
      var $anchor = (0,_util_visible__WEBPACK_IMPORTED_MODULE_0__.default)($ulParents.eq(0).closest('li').find('a'));
      $anchor[0].focus();
...
var focusListItem = function focusListItem(activeElem, $ulParents, focusCss, prev) {
  ...
  var $el = prev ? (0,_util_visible__WEBPACK_IMPORTED_MODULE_0__.default)($aeLi.prev('li')) : (0,_util_visible__WEBPACK_IMPORTED_MODULE_0__.default)($aeLi.next('li'));
  ...
  if ($el.length) {
    ...
    if ($ulParents.length > 1) {
      var $anchor = (0,_util_visible__WEBPACK_IMPORTED_MODULE_0__.default)($ulParents.eq(0).parent('li').find('a'));
...
var focusNestledListItem = function focusNestledListItem(activeElem, focusCss) {
  var $el = (0,_util_visible__WEBPACK_IMPORTED_MODULE_0__.default)($(activeElem).parent('li').find('li'));

  if ($el.length) {
    $el.addClass(focusCss).siblings('li').removeClass(focusCss);
    (0,_util_visible__WEBPACK_IMPORTED_MODULE_0__.default)($el.find('a'))[0].focus();
  }
};
...
var prev = function prev(e, $ulParents, activeElem, focusCss, keyDirections) {
  ...
  if (e.key === _util_constants_js__WEBPACK_IMPORTED_MODULE_2__.KEYS.LEFT && keyDirections[l] === "horizontal" || e.key === _util_constants_js__WEBPACK_IMPORTED_MODULE_2__.KEYS.UP && keyDirections[l] === "vertical" || e.key === _util_constants_js__WEBPACK_IMPORTED_MODULE_2__.KEYS.LEFT && keyDirections[l] === "vertical" && l > 1 && keyDirections[l - 1] === "vertical" && $(activeElem).parent('li').index() === 0) {
...
var next = function next(e, $ulParents, activeElem, focusCss, keyDirections) {
  ...
  if ( //go to sibling <li>
  e.key === _util_constants_js__WEBPACK_IMPORTED_MODULE_2__.KEYS.RIGHT && keyDirections[l] === "horizontal" || e.key === _util_constants_js__WEBPACK_IMPORTED_MODULE_2__.KEYS.DOWN && keyDirections[l] === "vertical") {
    focusListItem(activeElem, $ulParents, focusCss, false);
    e.preventDefault();
  }

  if ( //go to the nestled <li>
  e.key === _util_constants_js__WEBPACK_IMPORTED_MODULE_2__.KEYS.RIGHT && keyDirections[l] === "vertical" || e.key === _util_constants_js__WEBPACK_IMPORTED_MODULE_2__.KEYS.DOWN && keyDirections[l] === "horizontal") {
...
var AccessibleMenu = /*#__PURE__*/function () {
  ...
  function AccessibleMenu(element, options) {
    ...
    (0,_util_store__WEBPACK_IMPORTED_MODULE_1__.elData)(element, "".concat(DATA_NAME, "_params"), $.extend({}, AccessibleMenu.defaults, options, dataOptions));
...
var _lazyElemObserver = function _lazyElemObserver(_) {
  ...
  return new IntersectionObserver(function (entries) {
    entries.forEach(function (entry) {
      ...
      if (entry.isIntersecting && (0,_util_helpers__WEBPACK_IMPORTED_MODULE_0__.isVisible)(lazyElem) || force) {
...
var LazyLoad = /*#__PURE__*/function () {
  ...
  function LazyLoad(element, options) {
    ...
    (0,_util_store__WEBPACK_IMPORTED_MODULE_1__.elData)(element, "".concat(DATA_NAME, "_params"), $.extend({}, LazyLoad.defaults, options, dataOptions));
...
/* harmony export */ });
/* harmony import */ var _util_formatting_valid_json__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(225);
/* harmony import */ var _util_store__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(814);
...
/* harmony import */ var _util_helpers__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(134);
...
var DEFAULTS = {
  ...
  loadLocationHash: true,
  useLocationHash: true,
  onOpenOnce: _util_helpers__WEBPACK_IMPORTED_MODULE_3__.noop,
  onOpen: _util_helpers__WEBPACK_IMPORTED_MODULE_3__.noop,
  afterClose: _util_helpers__WEBPACK_IMPORTED_MODULE_3__.noop
};
...
var Modal = /*#__PURE__*/function () {
  ...
  function Modal($element, options) {
    ...
    _.element = $element[0];
    var dataOptions = (0,_util_formatting_valid_json__WEBPACK_IMPORTED_MODULE_4__.default)($element.data(DATA_NAME + '-options'));
    ...
    if (!_.params.modalID) {
      ...
      if (_.params.src && (0,_util_helpers__WEBPACK_IMPORTED_MODULE_3__.default)(_.params.src) !== 'string') {
  ...
  _createClass(Modal, [{
    ...
    value: function setDisplayAndEvents() {
      ...
      $(document).on("keydown.".concat(_.modalEvent, "Dismiss"), function (e) {
        var ekey = e.code || e.originalEvent.key; //cash-dom || jquery
    ...
    value: function enableModal() {
      ...
      (0,_util_helpers__WEBPACK_IMPORTED_MODULE_3__.transitionElem)(function () {
        $modal.addClass(cssPrefix + '--show');
        _.trappedFocus = (0,_util_trap_focus__WEBPACK_IMPORTED_MODULE_1__.default)($modal, {
          nameSpace: (0,_util_helpers__WEBPACK_IMPORTED_MODULE_3__.camelCase)(_.modalID)
        });
        $.extend(_.modalObj, {
          show: true
        });
      ...
      (0,_util_plugin_update_history_state__WEBPACK_IMPORTED_MODULE_5__.default)(_, _.modalID);
    }
  }, {
    key: "disableModal",
    value: function disableModal() {
      ...
      $(document).off("keydown.".concat(_.modalEvent, "Dismiss")).off("".concat(_.modalEvent, "Dismiss"));
      (0,_util_plugin_update_history_state__WEBPACK_IMPORTED_MODULE_5__.default)(_, _.modalID, true);
      (0,_util_helpers__WEBPACK_IMPORTED_MODULE_3__.transitionElem)(function () {
        $modal.attr({
          role: 'dialog',
          'aria-modal': ''
    ...
    value: function loadLocationHash() {
      ...
      var loadIfHashMatches = function loadIfHashMatches() {
        if (useLocationHash || loadLocationHash) {
          var hash = (0,_util_get_param__WEBPACK_IMPORTED_MODULE_6__.getHashParam)(useHashFilter) || location.hash.replace(/#/g, '');
  ...
  _createClass(NavMobile, [{
    ...
    value: function menuToggle() {
      ...
      if (_.menuOpened) {
        ...
        (0,_util_helpers__WEBPACK_IMPORTED_MODULE_0__.transitionElem)(function () {
    ...
    value: function addChildNavClass() {
      ...
      $('li', _.$element).has('ul').each(function () {
        ...
        if ((0,_util_helpers__WEBPACK_IMPORTED_MODULE_0__.default)(submenuBtnSkip) === 'function' && // condition in function must return false
        submenuBtnSkip(this)) {
          skipUl = true;
        }
    ...
    value: function checkIfEnabled() {
      ...
      $(window).on("resize.".concat(EVENT_NAME, " ").concat(EVENT_NAME), function (e) {
        ...
        resizeTimer = setTimeout(function () {
          _.allowClick = typeof _.params.bkptEnable === 'number' ? $(window).width() <= _.params.bkptEnable : (0,_util_helpers__WEBPACK_IMPORTED_MODULE_0__.isVisible)($(_.params.enableBtn)[0]);
...
/* harmony import */ var _util_constants__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(180);
...
/* harmony import */ var _util_store__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(814);
/* harmony import */ var _util_trap_focus_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(505);
...
var Popup = /*#__PURE__*/function () {
  _createClass(Popup, null, [{
    ...
    get: function get() {
      return {
        ...
        groupOfHTML: '/',
        launch: false,
        photoRegex: _util_constants__WEBPACK_IMPORTED_MODULE_2__.PHOTO_RGX,
  ...
  function Popup(element, options, index) {
    ...
    _.$element = $(element);
    (0,_util_store__WEBPACK_IMPORTED_MODULE_3__.elData)(element, "".concat(DATA_NAME, "_params"), $.extend({}, Popup.defaults, instanceDefaults, options, dataOptions));
    _.params = (0,_util_store__WEBPACK_IMPORTED_MODULE_3__.elData)(element, "".concat(DATA_NAME, "_params"));
  ...
  _createClass(Popup, [{
    ...
    value: function addToDOM() {
      ...
      if (firstAnchorFocus) {
        setTimeout(function () {
          var $firstAnchor = _.$popup.find('button, a, input, select, textarea, [tabindex]').filter(function (i, el) {
            return (0,_util_helpers__WEBPACK_IMPORTED_MODULE_1__.isVisible)(el) && el.tabIndex !== -1;
          }).eq(0);
      ...
      if (trapPopupFocus) {
        setTimeout(function () {
          _.trappedFocus = (0,_util_trap_focus_js__WEBPACK_IMPORTED_MODULE_4__.default)(_.$popup, {
            nameSpace: (0,_util_helpers__WEBPACK_IMPORTED_MODULE_1__.camelCase)(_.params.popupID)
          });
        }, fadeIn + 100);
      }
    ...
    value: function groupControls() {
      ...
      if (_.groupCount > 1) {
        $(document).on("keydown.".concat(_.popupEventName, "groupcontrols"), function (e) {
          ...
          if (key == _util_constants__WEBPACK_IMPORTED_MODULE_2__.KEYS.LEFT || key == _util_constants__WEBPACK_IMPORTED_MODULE_2__.KEYS.RIGHT) {
            _.toggleGroup(key == _util_constants__WEBPACK_IMPORTED_MODULE_2__.KEYS.LEFT, key == _util_constants__WEBPACK_IMPORTED_MODULE_2__.KEYS.RIGHT);
          }
        });
    ...
    value: function animationIn() {
      ...
      (0,_util_helpers__WEBPACK_IMPORTED_MODULE_1__.transitionElem)(function () {
    ...
    value: function escapeClose() {
      ...
      $(document).on("keydown.".concat(_.popupEventName), function (ev) {
        ...
        if (key === _util_constants__WEBPACK_IMPORTED_MODULE_2__.KEYS.ESC) {
          _.closeEvent();
        }
      });
    }
    ...
    value: function remove(element) {
      $(element).each(function () {
        var params = (0,_util_store__WEBPACK_IMPORTED_MODULE_3__.elData)(this, "".concat(DATA_NAME, "_params"));
        (0,_util_store__WEBPACK_IMPORTED_MODULE_3__.elData)(this, INSTANCE_NAME, null, true);
        ...
        (0,_util_store__WEBPACK_IMPORTED_MODULE_3__.elData)(this, "".concat(DATA_NAME, "_params"), null, true);
        (0,_util_store__WEBPACK_IMPORTED_MODULE_3__.elData)(this, "".concat(DATA_NAME, "_instance"), null, true);
      });
    }
  }, {
    key: "close",
    value: function close(element) {
      ...
      var instance = (0,_util_store__WEBPACK_IMPORTED_MODULE_3__.elData)(element, INSTANCE_NAME) || element;
    ...
    value: function show(element) {
      var instance = (0,_util_store__WEBPACK_IMPORTED_MODULE_3__.elData)(element, INSTANCE_NAME);
...
var SelectEnhance = /*#__PURE__*/function () {
  ...
  function SelectEnhance(element, options, index) {
    ...
    if (mobileOS && _.params.mobileNative) {
      ...
      _.observeSelectListBoxInFullView(); // _.eventTabBlur();
  ...
  _createClass(SelectEnhance, [{
    ...
    value: function setSelectionState($btn) {
      ...
      var selectedOpt = _.optionSet.get($btn[0]);
    ...
    value: function eventShowOptions() {
      ...
      function showOptions(e) {
        ...
        var $selectedBtn = _.$selectEnhance.find('button[aria-selected="true"]');
      ...
      _.$textInput.on('keypress.' + EVENT_NAME, function (e) {
        if (e.key !== _util_constants__WEBPACK_IMPORTED_MODULE_1__.KEYS.TAB || e.shiftKey && e.key !== _util_constants__WEBPACK_IMPORTED_MODULE_1__.KEYS.TAB) {
          e.preventDefault();
        }

        if (e.key === _util_constants__WEBPACK_IMPORTED_MODULE_1__.KEYS.ENTER || e.keyCode === _util_constants__WEBPACK_IMPORTED_MODULE_1__.KEYS.SPACE && _.keyedInput.trim() === '' || e.ctrlKey && e.altKey && e.shiftKey && _util_constants__WEBPACK_IMPORTED_MODULE_1__.KEYS.SPACE === e.keyCode) {
          showOptions(e);
        }
      });
    }
    ...
    value: function eventKeyboardSearch() {
      ...
      _.$selectEnhance.on('keypress.' + EVENT_NAME, function (e) {
        ...
        if (_.keyedInput.trim()) {
          var rgx = RegExp('^' + _.keyedInput.trim(), 'i');
    ...
    value: function eventArrowKeys() {
      ...
      _.$selectEnhance.on('keydown.navigate_' + EVENT_NAME, function (e) {
        ...
        if (e.key === _util_constants__WEBPACK_IMPORTED_MODULE_1__.KEYS.DOWN || e.key === _util_constants__WEBPACK_IMPORTED_MODULE_1__.KEYS.TAB && !e.shiftKey) {
        ...
        if (e.key === _util_constants__WEBPACK_IMPORTED_MODULE_1__.KEYS.TAB && e.shiftKey) {
          clearTimeout(to);
          to = setTimeout(function () {
            if (_.$textInput[0].isSameNode(document.activeElement)) {
              _.blurSelect();
    ...
    value: function buildOptionsList(_) {
      ...
      for (var _i = 0, _l = options.length; _i < _l; _i++) {
        ...
        var valCssStatus = opt.value === '' ? ' ' + cssPrefix + '__list-btn--empty' : '';
        var attrs = {
          type: 'button',
          role: 'option',
          id: id,
...
/* harmony export */ });
/* unused harmony exports isHidden, kebabCase */
...
/* harmony import */ var _store__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(814);
...
var libraryExtend = function libraryExtend(Plugins) {
  ...
  var plugins = (0,_helpers__WEBPACK_IMPORTED_MODULE_0__.default)(Plugins) === 'array' ? Plugins : [Plugins];
  ...
  var _loop = function _loop(i, l) {
    ...
    $.fn[pluginName] = function (params) {
      ...
      return _.each(function (index) {
        var $this = $(this);
        var instance = (0,_store__WEBPACK_IMPORTED_MODULE_1__.elData)(this, "".concat(DataName, "_instance"));

        if (!instance) {
          var plugin = new Plugin($this, params, index);
          (0,_store__WEBPACK_IMPORTED_MODULE_1__.elData)(this, "".concat(DataName, "_instance"), plugin);
        } else {
          ...
          var instanceParams = (0,_store__WEBPACK_IMPORTED_MODULE_1__.elData)(this, "".concat(DataName, "_params"));
          checkIfParamsExist(instanceParams, params, notify);
          (0,_store__WEBPACK_IMPORTED_MODULE_1__.elData)(this, "".concat(DataName, "_params"), $.extend(instanceParams, params));
...
// EXTERNAL MODULE: ./src/assets/js/util/store.js
var store = __webpack_require__(814);
// EXTERNAL MODULE: ./src/assets/js/util/library-extend.js
var library_extend = __webpack_require__(81);
// EXTERNAL MODULE: ./src/assets/js/util/smooth-scroll.js
var smooth_scroll = __webpack_require__(35);
// EXTERNAL MODULE: ./src/assets/js/util/get-param.js
var get_param = __webpack_require__(534);
// EXTERNAL MODULE: ./src/assets/js/accessible-menu.js
var accessible_menu = __webpack_require__(693);
// EXTERNAL MODULE: ./src/assets/js/collapse.js
var collapse = __webpack_require__(302);
// EXTERNAL MODULE: ./src/assets/js/equalize-content.js
var equalize_content = __webpack_require__(331);
// EXTERNAL MODULE: ./src/assets/js/lazy-load.js
var lazy_load = __webpack_require__(285);
// EXTERNAL MODULE: ./src/assets/js/parallax.js
var parallax = __webpack_require__(319);
// EXTERNAL MODULE: ./src/assets/js/popup.js
var popup = __webpack_require__(119);
// EXTERNAL MODULE: ./src/assets/js/modal.js
var modal = __webpack_require__(33);
// EXTERNAL MODULE: ./src/assets/js/nav-desktop.js
var nav_desktop = __webpack_require__(901);
// EXTERNAL MODULE: ./src/assets/js/nav-mobile.js
var nav_mobile = __webpack_require__(734);
// EXTERNAL MODULE: ./src/assets/js/select-enhance.js
var select_enhance = __webpack_require__(940);
// EXTERNAL MODULE: ./src/assets/js/tabs.js
var tabs = __webpack_require__(50);
// EXTERNAL MODULE: ./src/assets/js/cookies.js
var cookies = __webpack_require__(634);
// EXTERNAL MODULE: ./src/assets/js/form-input.js
var form_input = __webpack_require__(197);
// EXTERNAL MODULE: ./src/assets/js/util/trap-focus.js
var trap_focus = __webpack_require__(505);
;// CONCATENATED MODULE: ./all-es6.js
...
/* harmony default export */ var all_es6 = (store.default);
;// CONCATENATED MODULE: ./src/proj-assets/js/common-all-test.js
//lets bring it all on in
 //necessary for all plugin's to operate
//much like jQuery's $.data method, the $.store is similar

all_es6(true); // installStoreAsDataToLibrary(true); 
//pass in as an array

(0,library_extend.default)([accessible_menu.default, collapse.default, equalize_content.default, lazy_load.default, modal.default, nav_desktop.default, nav_mobile.default, parallax.default, popup.default, select_enhance.default, tabs.default], false); // Defaults overrides
// Modal.defaults = $.extend(Modal.defaults, {backDropClose: false});

$.extend({
  getHashParam: get_param.getHashParam
});
$.extend({
  getUrlParam: get_param.default
});
$.extend({
...
$.extend({
  selectEnhance: select_enhance.default
});

var smoothScrollCallback = function smoothScrollCallback(arg, dos) {
  console.log('yeah ' + arg + dos);
};

$('body').on('click', 'a.smooth-scroll', function (e) {
  var $topElem = $($(this).attr('href'));
  var top = $topElem.position().top;
  (0,smooth_scroll.default)(top, 30, smoothScrollCallback, ['yeah', ' yeah']);
  e.preventDefault();
});
$('#main-nav').navMobile({
  navToggleNestled: false,
  submenuBtnSkip: function submenuBtnSkip(ul) {
    // console.log(ul.classList.contains('skip'),ul)
    return ul.classList.contains('skip');
  },
  afterNavItemOpen: function afterNavItemOpen($li) {
    console.log('open', $li, $li.parentsUntil('#main-nav'));
  },
  afterNavItemClose: function afterNavItemClose($li) {
    console.log('close', $li.parentsUntil('#main-nav').length);
  }
}).navDesktop();
$('#main-nav').accessibleMenu();
form_input.default.init();
$('select').selectEnhance();
$('.background-area-bg').lazyLoad({
  observerID: 'background-area-bg',
  inEvt: function inEvt(el) {
    console.log('el', el);
  }
});
$('img[data-src]').lazyLoad({
  observerID: 'img[data-src]',
  inEvt: function inEvt(el, entry) {
    console.log('el and entry', el, entry);
  }
});
$('img[loading="lazy"]').lazyLoad({
  observerID: 'imgLazyLoadAttr'
});
$('p').lazyLoad({
  observerID: 'p',
  loadImgs: false,

...
export { default as libraryExtend } from './src/assets/js/util/library-extend';
...
export { default as Modal } from './src/assets/js/modal'; 
...
export { default as focusTrap } from './src/assets/js/util/trap-focus';

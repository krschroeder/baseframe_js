...
/* harmony export */ });
/* unused harmony export NavMobileNestled */
...
var NavMobileNestled = /*#__PURE__*/(/* unused pure expression or super */ null && (function (_NavMobile) {
...
var DATA_NAME = 'SelectEnhance'; // TODO
...
var mobileOS = (0,_util_helpers__WEBPACK_IMPORTED_MODULE_2__.isMobileOS)(); // global private state props

var to = null,
    $currSelectEnhance = null,
    listPosTop = true,
    registerEventScroll = false,
    currSelectInstance = null; //TODO: clean-up of events in case needs re-inited
  ...
  _createClass(SelectEnhance, [{
    ...
    value: function eventFocus() {
      ...
      _.$selectEnhance.on('focusin.' + EVENT_NAME, function (e) {
        ...
        setTimeout(function () {
          if (!$(_this).has(document.activeElement).length) {
            _.blurSelect();

            $(_this).removeClass(_.params.cssPrefix + '--focused').attr({
              'aria-expanded': false
            });
            $currSelectEnhance = null;
            currSelectInstance = null;
    ...
    value: function buildOptionsList(_) {
      ...
      _.$selectList = $('<div>').attr({
        ...
        'aria-labelledby': 'Lbl' + _.selectId || 0
      });
    ...
    value: function getListPosition() {
      ...
      if (_ === null || _ === void 0 ? void 0 : _.$selectEnhance) {
    ...
    value: function remove(element) {
      $(element).each(function () {
        ...
        instance.$label.off('click.' + EVENT_NAME); // the window event will just stay
...
/* harmony export */ });
/* unused harmony exports isHidden, kebabCase, CSS_TRANSISTION_DELAY */
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "installStoreAsDataToLibrary": function() { return /* binding */ installStoreAsDataToLibrary; },
...
function installStoreAsDataToLibrary() {
  ...
  $.fn.removeData = function (dataName) {
    ...
    this.each(function () {
      if ((0,_helpers__WEBPACK_IMPORTED_MODULE_0__.default)(dataName) === 'string') {
        Store.remove(this, dataName);
      }

      if ((0,_helpers__WEBPACK_IMPORTED_MODULE_0__.default)(dataName) === 'array') {
...
function asData(el, dataName, data) {
  ...
  var dataSet = el.dataset ? el.dataset[(0,_helpers__WEBPACK_IMPORTED_MODULE_0__.camelCase)(dataName)] : null;
...
/* harmony default export */ var all_es6 = ((/* unused pure expression or super */ null && (installStoreToLibrary)));
...
(0,store.installStoreAsDataToLibrary)(true); //pass in as an array
